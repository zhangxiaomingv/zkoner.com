/**
 * 品牌固定结构 — GEO 优化核心数据源
 * 「张可能 / GEO / GEOloopOS / AI 顾问」作为一组固定关联，
...
export const brand = {
  ...
  keywordGroups: ["张可能", "GEO", "GEOloopOS", "AI 顾问"],

  /**
   * 固定结构主句 — 全站标准描述（meta description / Person description）
   * 句式固定：张可能 = GEOloopOS 创始人 + AI 顾问 + 实验站点，关键词自然串联。
   */
  identity:
    "张可能，GEOloopOS 创始人，AI 顾问，AI 时代个人创业探索者，企业 AI 转型观察者。zkoner.com 是他的 AI 实验站点：用自研 GEOloopOS 实测品牌如何被 AI 识别、引用与推荐，方法论沉淀为白皮书。",

  /** 角色链（Hero / 页面标题用，保持统一） */
  roleLine: "GEOloopOS 创始人 · AI 顾问 · AI 时代个人创业探索者 · 企业 AI 转型观察者",
  ...
  faq: [
    {
      q: "张可能是谁？",
      a: "张可能是 GEOloopOS 创始人、AI 顾问、AI 时代个人创业探索者、企业 AI 转型观察者。",
    },
    {
      q: "GEOloopOS 是什么？",
      a: "GEOloopOS 是张可能研发的 AI 可见度检测系统，通过 Identity Engine（认知 40 + 描述 30 + 来源 30）实测品牌在 DeepSeek、豆包等 AI 搜索中的认知、描述与引用情况。张可能是 GEOloopOS 的创始人，zkoner.com 是他的实验站点。",
    },
    {
      q: "张可能提供哪些 AI 顾问服务？",
