/**
 * 商业白皮书 · 完整正文
 * 生成自 docs/whitepaper.md（勿手动编辑正文，改源文件后重新生成）。
...
export const whitepaper: WhitepaperMeta = {
  slug: "whitepaper",
  title: "GEOloop：AI可见度闭环方法论",
  subtitle: "—— 中文 AI 搜索环境下的实体认知、可见度与持续优化",
  edition: "GEOloop Lab · Experiment #001 · 商业白皮书",
  author: "张晓明",
  authorRole: "GEO 与 AI 搜索可见度独立顾问",
  date: "2026-08-16 ~ 2026-08-18",
  datePublished: "2026-08-18",
  description: "GEOloop 商业白皮书：中文 AI 搜索环境下的实体认知、可见度与持续优化。基于 Experiment #001 双源实测（DeepSeek + 豆包）建立实体认知基线，提出 AI Entity、AI Perception Gap、AI 可见度四层模型、GEOloop 闭环与 Entity-first GEO 方法论。",
  body: `## 目录
