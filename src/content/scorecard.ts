/**
 * AI 认知成绩单 — 每月用 GEOloop 检测「AI 眼中的张晓明」，把成绩公开。
 *
...
export const scorecardOpening =
  "我是张晓明，GEOloop 创始人 / AI 顾问 / GEO 优化工程师。每个月我都用自己的 GEOloop 检测「AI 眼中的我」，把成绩公开出来。";
...
export const scorecards: ScorecardIssue[] = [
  {
    ...
    dimensions: [
      {
        key: "认知",
        status: "模糊",
        note: "豆包知道「张晓明」是个人名，DeepSeek 完全不认识——AI 还没把你当作一个「实体」记住。",
      },
      {
        key: "描述",
        status: "浅",
    ...
    providers: [
      {
        name: "DeepSeek",
        status: "refused",
        result: "两个问题均直接拒答——DeepSeek 语料里查无「张晓明」这个实体。",
        quote:
      ...
      },
      {
        ...
        status: "partial",
        result:
          "认出「张晓明」是个少见中文人名，但查无企业、品牌、产品与公开服务。",
        quote:
          "「张晓明」最普遍的含义是中文人名，姓氏为张，单名“可能”，这个取名比较有巧思……目前没有全国范围知名度极高的公众人物使用这个名字。……目前公开的工商备案、品牌注册及主流商业平台信息中，暂未查询到名为「张晓明」的知名企业、品牌或标准化服务主体哦。",
        score: 70,
      },
    ],
    scene: {
      ...
      myShare: 0,
      leader: "无人被点名推荐",
      note: "两源共 2 份回答，没有任何一位中国 GEO 顾问被点名。张晓明的曝光份额为 0%。",
      samples: [
        {
          provider: "DeepSeek",
          excerpt:
    ...
    actions: [
      ...
      {
        text: "定位锚点落地：固定「张晓明 — AI 顾问 / GEO 优化工程师 / GEOloop 创始人」，口径逐字统一。",
        logRef: "06",
      },
      {
    ...
    next: [
      "发 3–5 篇「张晓明 × GEO」公开内容（个人站 / 知乎 / 公众号），让品牌名与场景词同框出现。",
      "1–2 周后用 GEOloop 文章监测，看内容是否被 DeepSeek / 豆包引用。",
      "复测目标：总分 ≥ 40（跨过「AI 认知模糊」线），场景推荐曝光 > 0%。",
    ],
    insight:
      "AI 已经能讲清楚 GEO 是什么，甚至报得出 Greg Sterling、Jim Lecinski 这些全球名字。但当问题落到「推荐一位中国 GEO 顾问」，两个源都只给出“找顾问的方法”，没有点名任何一个人——公开语料里还不存在「张晓明 = GEO 顾问」这条实体记录。空位已经在，谁先补上，谁就拿到 AI 的推荐权。",
  },
];
